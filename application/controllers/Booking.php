...
class Booking extends CI_Controller
{
   ...
   public function exportToPdf()
   {
      ...
      $data['useraktif'] = $this->ModelUser->cekData(['id' => $this->session->userdata('id_user')])->result();
      $data['items'] = $this->db->query("select * from booking, booking_detail, buku where booking.id_booking = booking_detail.id_booking and booking_detail.id_buku = buku.id and booking.id_user='$id_user'")->result_array();
